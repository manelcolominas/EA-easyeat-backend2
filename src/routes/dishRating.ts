 ...
 *   get:
 *     summary: List ratings for a dish (paginated)
 *     tags: [DishRatings]
 *     parameters:
 *       - in: path
 *         name: dish_id
 ...
 *   get:
 *     summary: Get rating summary (count, average, distribution) for a dish
 *     tags: [DishRatings]
 *     parameters:
 *       - in: path
 *         name: dish_id
 ...
 *   get:
 *     summary: List a customer's dish ratings (paginated, self or admin)
 *     tags: [DishRatings]
 *     security:
 *       - bearerAuth: []
 *     parameters:
