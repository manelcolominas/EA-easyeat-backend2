...
const getRestaurantGlobalRating = (restaurantId) => __awaiter(void 0, void 0, void 0, function* () {
...
const getRestaurant = (restaurant_id) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (!restaurant)
        return null;
    return Object.assign(Object.assign({}, restaurant), { profile: Object.assign(Object.assign({}, restaurant.profile), { globalRating, image: (_a = restaurant.profile.image) === null || _a === void 0 ? void 0 : _a.slice(0, 3) }) });
});
const getDeletedRestaurant = (restaurantId) => __awaiter(void 0, void 0, void 0, function* () {
    return restaurant_1.RestaurantModel.findOne({ _id: restaurantId, deletedAt: { $ne: null } }).lean();
});
const getAllRestaurants = (skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllDeletedRestaurants = (skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateRestaurant = (restaurant_id, data) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const softDeleteRestaurant = (restaurant_id) => __awaiter(void 0, void 0, void 0, function* () {
    return restaurant_1.RestaurantModel.findOneAndUpdate({ _id: restaurant_id, deletedAt: null }, // guard: only active docs
    { deletedAt: new Date() }, { new: true }).lean();
});
/**
 ...
 */
const restoreRestaurant = (restaurant_id) => __awaiter(void 0, void 0, void 0, function* () {
    return restaurant_1.RestaurantModel.findOneAndUpdate({ _id: restaurant_id, deletedAt: { $ne: null } }, // guard: only deleted docs
    { deletedAt: null }, { new: true }).lean();
});
/**
 * Hard-delete: permanently removes the document.
 * Use only for admin operations or GDPR erasure requests.
 */
const hardDeleteRestaurant = (restaurant_id) => __awaiter(void 0, void 0, void 0, function* () {
    return restaurant_1.RestaurantModel.findByIdAndDelete(restaurant_id).lean();
});
// ─────────────────────────────────────────────────────────────────────────────
// Read variants
// ─────────────────────────────────────────────────────────────────────────────
const getRestaurantCustomers = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDeletedRestaurantCustomers = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = { favoriteRestaurants: new mongoose_1.default.Types.ObjectId(restaurant_id), deletedAt: null };
    const [customers, total] = yield Promise.all([customer_1.CustomerModel.find(filter).skip(skip).limit(limit).lean(), customer_1.CustomerModel.countDocuments(filter)]);
    return { customers, total };
});
const getRestaurantFull = (restaurant_id) => __awaiter(void 0, void 0, void 0, function* () {
    const [restaurant, globalRating] = yield Promise.all([
        restaurant_1.RestaurantModel.findById(restaurant_id)
            .populate('employees')
            .populate('rewards')
...
const getRestaurantDetailedForCustomerFrontend = (restaurant_id) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDeletedRestaurantFull = (restaurantId) => __awaiter(void 0, void 0, void 0, function* () {
...
const getReestaurantsNearby = (lng, lat, maxDistance) => __awaiter(void 0, void 0, void 0, function* () {
...
const getBadges = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const total = yield restaurant_1.RestaurantModel.findById(restaurant_id)
        .lean()
        .then((r) => { var _a; return ((_a = r === null || r === void 0 ? void 0 : r.badges) === null || _a === void 0 ? void 0 : _a.length) || 0; });
    return { badges: restaurant.badges || [], total };
});
const getDeletedRestaurantBadges = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const restaurant = yield restaurant_1.RestaurantModel.findById(restaurant_id)
        .populate({
        path: 'badges',
...
const getStatistics = (restaurant_id) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDeletedRestaurantStatistics = (restaurant_id) => __awaiter(void 0, void 0, void 0, function* () {
...
const getEmployees = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDeletedRestaurantEmployees = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = { restaurant_id: new mongoose_1.default.Types.ObjectId(restaurant_id), isActive: false };
    const [employees, total] = yield Promise.all([employee_1.EmployeeModel.find(filter).skip(skip).limit(limit).lean(), employee_1.EmployeeModel.countDocuments(filter)]);
    return { employees, total };
});
const getDishes = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDeletedRestaurantDishes = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = { restaurant_id: new mongoose_1.default.Types.ObjectId(restaurant_id), active: false };
    const [dishes, total] = yield Promise.all([dish_1.DishModel.find(filter).skip(skip).limit(limit).lean(), dish_1.DishModel.countDocuments(filter)]);
    return { dishes, total };
});
const getTopDishByRestaurant = (restaurantId) => __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(restaurantId))
        return null;
    const pipeline = [
        {
...
const getRewards = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = { restaurant_id: new mongoose_1.default.Types.ObjectId(restaurant_id), active: true };
...
const getDeletedRestaurantRewards = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = { restaurant_id: new mongoose_1.default.Types.ObjectId(restaurant_id), active: false };
    const [rewards, total] = yield Promise.all([reward_1.RewardModel.find(filter).skip(skip).limit(limit).lean(), reward_1.RewardModel.countDocuments(filter)]);
    return { rewards, total };
});
const getVisits = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDeletedRestaurantVisits = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = { restaurant_id: new mongoose_1.default.Types.ObjectId(restaurant_id), deletedAt: { $ne: null } };
    const [visits, total] = yield Promise.all([visit_1.VisitModel.find(filter).skip(skip).limit(limit).lean(), visit_1.VisitModel.countDocuments(filter)]);
    return { visits, total };
});
const getReviews = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDeletedRestaurantReviews = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
// ─────────────────────────────────────────────────────────────────────────────
const updateGlobalRating = (restaurant_id, newAverage) => __awaiter(void 0, void 0, void 0, function* () {
...
const getFilteredRestaurants = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (hasGeo) {
        if (city)
            baseFilter['profile.location.city'] = { $regex: city, $options: 'i' };
        if (minGlobalRating)
            baseFilter['profile.globalRating'] = { $gte: minGlobalRating };
        if (categories === null || categories === void 0 ? void 0 : categories.length)
            baseFilter['profile.category'] = { $in: categories };
        pipeline.push({
            $geoNear: {
