...
const createRewardRedemption = (data) => __awaiter(void 0, void 0, void 0, function* () {
...
const redeemReward = (data) => __awaiter(void 0, void 0, void 0, function* () {
...
const getRewardRedemption = (redemptionId) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllRewardRedemptions = (skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getByEmployee = (employee_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const [redemptions, total] = yield Promise.all([
...
const getByReward = (reward_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const [redemptions, total] = yield Promise.all([
...
const updateRewardRedemption = (redemptionId, data) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateStatus = (redemptionId, data) => __awaiter(void 0, void 0, void 0, function* () {
    const redemption = yield rewardRedemption_1.RewardRedemptionModel.findById(redemptionId);
    if (!redemption)
        return null;
...
const deleteRewardRedemption = (redemptionId) => __awaiter(void 0, void 0, void 0, function* () {
...
const redeemRewardWithoutTransaction = (data) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const { customer_id, reward_id, employee_id, notes } = data;
    if (!mongoose_1.default.Types.ObjectId.isValid(customer_id)) {
        throw buildError(400, 'Invalid customer_id');
