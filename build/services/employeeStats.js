 ...
 */
const getEmployeeStatistics = (employee_id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield employeeStats_1.EmployeeStatsModel.findOne({ employee_id }).lean();
});
/**
 * Save or update employee statistics
 */
const saveEmployeeStatistics = (employee_id, stats) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const employeeId = new mongoose_1.Types.ObjectId(employee_id);
        return yield employeeStats_1.EmployeeStatsModel.findOneAndUpdate({ employee_id: employeeId }, Object.assign(Object.assign({}, stats), { employee_id: employeeId }), { upsert: true, new: true, runValidators: true });
    }
    catch (error) {
 ...
 */
const calculateAndSaveEmployeeStatistics = (employee_id) => __awaiter(void 0, void 0, void 0, function* () {
