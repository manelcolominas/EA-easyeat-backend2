        ...
        try {
          ...
          if (((_a = err.response) === null || _a === void 0 ? void 0 : _a.status) !== 404) {
            logging_1.default.error(
              `Google Wallet GET object failed: status=${(_b = err.response) === null || _b === void 0 ? void 0 : _b.status} statusText=${(_c = err.response) === null || _c === void 0 ? void 0 : _c.statusText} data=${JSON.stringify((_d = err.response) === null || _d === void 0 ? void 0 : _d.data)}`
            );
            throw err;
          }
        }
