 ...
 */
const getCustomerStatistics = (customer_id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield customerStats_1.CustomerStatsModel.findOne({ customer_id }).lean();
});
/**
 * Save or update customer statistics
 */
const saveCustomerStatistics = (customer_id, stats) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const customerId = new mongoose_1.Types.ObjectId(customer_id);
        return yield customerStats_1.CustomerStatsModel.findOneAndUpdate({ customer_id: customerId }, Object.assign(Object.assign({}, stats), { customer_id: customerId }), { upsert: true, new: true, runValidators: true });
    }
    catch (error) {
 ...
 */
const calculateAndSaveCustomerStatistics = (customer_id) => __awaiter(void 0, void 0, void 0, function* () {
