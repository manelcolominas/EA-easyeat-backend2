 ...
 */
const rateOrUpdateDish = (customer_id, dish_id, rating) => __awaiter(void 0, void 0, void 0, function* () {
...
const getRatingsByDish = (dish_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const [dishRatings, total] = yield Promise.all([dishRating_1.DishRatingModel.find({ dish_id: dish_id }).skip(skip).limit(limit).lean(), dishRating_1.DishRatingModel.countDocuments({ dish_id: dish_id })]);
    return { dishRatings, total };
});
// ─── Read ratings for a customer ─────────────────────────────────────────────
const getRatingsByCustomer = (customer_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const softDeleteRating = (rating_id, customer_id) => __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(rating_id))
        return null;
    const filter = { _id: rating_id, deletedAt: null };
    if (customer_id)
        filter.customer_id = new mongoose_1.default.Types.ObjectId(customer_id);
    return dishRating_1.DishRatingModel.findOneAndUpdate(filter, { deletedAt: new Date() }, { new: true }).lean();
});
// ─── Rating summary (aggregation) ────────────────────────────────────────────
const getDishRatingSummary = (dish_id) => __awaiter(void 0, void 0, void 0, function* () {
    const pipeline = [
...
const getTopDishByRestaurant = (restaurant_id) => __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(restaurant_id))
        return null;
    const pipeline = [
        {
            $match: {
...
const getTopDishesByRestaurant = (restaurant_id) => __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.default.Types.ObjectId.isValid(restaurant_id))
        return [];
    const pipeline = [
        {
