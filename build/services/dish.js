...
const createDish = (data) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDish = (dish_id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield dish_1.DishModel.findById(dish_id);
});
const getDeletedDish = (dish_id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield dish_1.DishModel.findOne({ _id: dish_id, active: false }).lean();
});
const getAllDishes = (skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllDeletedDishes = (skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateDish = (dish_id, data) => __awaiter(void 0, void 0, void 0, function* () {
...
const softDeleteDish = (dish_id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield dish_1.DishModel.findByIdAndUpdate(dish_id, { active: false }, { new: true }).lean();
});
const restoreDish = (dish_id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield dish_1.DishModel.findByIdAndUpdate(dish_id, { active: true }, { new: true }).lean();
});
const hardDeleteDish = (dish_id) => __awaiter(void 0, void 0, void 0, function* () {
