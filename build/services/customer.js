...
// ─── Read (single) ────────────────────────────────────────────────────────────
const getCustomer = (customer_id) => __awaiter(void 0, void 0, void 0, function* () {
    return customer_1.CustomerModel.findById(customer_id);
});
const getDeletedCustomer = (customer_id) => __awaiter(void 0, void 0, void 0, function* () {
    return customer_1.CustomerModel.findOne({ _id: customer_id, deletedAt: { $ne: null } });
});
const getCustomerFull = (customer_id) => __awaiter(void 0, void 0, void 0, function* () {
    return customer_1.CustomerModel.findById(customer_id)
...
const getDeletedCustomerFull = (customer_id) => __awaiter(void 0, void 0, void 0, function* () {
    return customer_1.CustomerModel.findOne({ _id: customer_id, deletedAt: { $ne: null } })
        .populate('pointsWallet')
        .populate('visitHistory')
        .populate({
...
const getCustomerAllPointsWallet = (customer_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getCustomerAllVisits = (customer_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getCustomerAllDeletedVisits = (customer_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getCustomerAllFavouriteRestaurants = (customer_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getCustomerAllBadges = (customer_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getCustomerAllReviews = (customer_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
// ─── Read (paginated list) ────────────────────────────────────────────────────
const getAllCustomers = (skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllDeletedCustomers = (skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = { deletedAt: { $ne: null } };
    const [data, total] = yield Promise.all([customer_1.CustomerModel.find(filter).skip(skip).limit(limit).lean(), customer_1.CustomerModel.countDocuments(filter)]);
    return { data, total };
});
const getCustomersByRestaurant = (restaurant_id, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
// ─── Update ───────────────────────────────────────────────────────────────────
const updateCustomer = (customer_id, data) => __awaiter(void 0, void 0, void 0, function* () {
...
// ─── Soft Delete ──────────────────────────────────────────────────────────────
const softDeleteCustomer = (customer_id) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, softDelete_1.softDeleteDocument)(customer_1.CustomerModel, customer_id);
});
// ─── Restore ─────────────────────────────────────────────────────────────────
const restoreCustomer = (customer_id) => __awaiter(void 0, void 0, void 0, function* () {
    return (0, softDelete_1.restoreDocument)(customer_1.CustomerModel, customer_id);
});
// ─── Hard Delete (admin only) ─────────────────────────────────────────────────
const hardDeleteCustomer = (customer_id) => __awaiter(void 0, void 0, void 0, function* () {
