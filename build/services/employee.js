...
const getAllDeletedEmployees = (skip, limit) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const [employees, total] = yield Promise.all([
...
const getByRestaurantWithStats = (restaurant_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateEmployee = (employee_id, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
