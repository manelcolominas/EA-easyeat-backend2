...
const createReview = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const review = new review_1.ReviewModel(Object.assign(Object.assign({}, data), { customer_id: new mongoose_1.default.Types.ObjectId(data.customer_id), restaurant_id: new mongoose_1.default.Types.ObjectId(data.restaurant_id) }));
    return review.save();
});
...
const getDeletedReview = (reviewId) => __awaiter(void 0, void 0, void 0, function* () {
    return review_1.ReviewModel.findOne(Object.assign({ _id: reviewId }, DELETED_REVIEW_FILTER))
        .populate('customer_id', 'name profilePictures')
        .populate('restaurant_id', 'name')
        .lean();
});
const getAllReviews = (skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllDeletedReviews = (skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const [reviews, total] = yield Promise.all([
...
const updateReview = (reviewId, data) => __awaiter(void 0, void 0, void 0, function* () {
    const { _id, customer_id, restaurant_id } = data, safeData = __rest(data, ["_id", "customer_id", "restaurant_id"]);
...
// ─── Delete / Restore ─────────────────────────────────────────────────────────
const softDeleteReview = (reviewId) => __awaiter(void 0, void 0, void 0, function* () {
    return review_1.ReviewModel.findOneAndUpdate(Object.assign({ _id: reviewId }, ACTIVE_REVIEW_FILTER), { deleted: true }, { new: true }).lean();
});
const restoreReview = (reviewId) => __awaiter(void 0, void 0, void 0, function* () {
...
const hardDeleteReview = (reviewId) => __awaiter(void 0, void 0, void 0, function* () {
    return review_1.ReviewModel.findByIdAndDelete(reviewId).lean();
});
// ─── Queries by relation ──────────────────────────────────────────────────────
const getReviewsByRestaurant = (restaurantId, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
    const filter = Object.assign({ restaurant_id: new mongoose_1.default.Types.ObjectId(restaurantId) }, ACTIVE_REVIEW_FILTER);
    const [reviews, total] = yield Promise.all([review_1.ReviewModel.find(filter).populate('customer_id', 'name profilePictures').skip(skip).limit(limit).lean(), review_1.ReviewModel.countDocuments(filter)]);
    return { reviews, total };
});
const getDeletedReviewsByRestaurant = (restaurantId, skip, limit) => __awaiter(void 0, void 0, void 0, function* () {
...
const getReviewsByCustomer = (customerId_1, skip_1, limit_1, ...args_1) => __awaiter(void 0, [customerId_1, skip_1, limit_1, ...args_1], void 0, function* (customerId, skip, limit, options = {}) {
...
const getDeletedReviewsByCustomer = (customerId_1, skip_1, limit_1, ...args_1) => __awaiter(void 0, [customerId_1, skip_1, limit_1, ...args_1], void 0, function* (customerId, skip, limit, options = {}) {
...
// ─── Like ─────────────────────────────────────────────────────────────────────
const likeReview = (reviewId) => __awaiter(void 0, void 0, void 0, function* () {
