...
const getStatistics = (statistics_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield statistics_1.StatisticsModel.findById(statistics_id);
  });
const getAllStatistics = (skip, limit) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getByRestaurant = (restaurant_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield statistics_1.StatisticsModel.findOne({ restaurant_id });
  });
const updateStatistics = (statistics_id, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteStatistics = (statistics_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
