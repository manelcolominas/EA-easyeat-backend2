...
const getPointsWallet = (walletId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return yield pointsWallet_1.PointsWalletModel.findById(walletId);
  });
const getAllPointsWallets = (skip, limit) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updatePointsWallet = (walletId, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deletePointsWallet = (walletId) =>
  __awaiter(void 0, void 0, void 0, function* () {
