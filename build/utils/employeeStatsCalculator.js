 ...
 */
const calculateTotalVisitsHandled = (employeeId) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const calculateTotalCustomersServed = (employeeId) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
 ...
 */
const calculateTotalRevenueGenerated = (employeeId) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const result = yield visit_1.VisitModel.aggregate([
        {
            $match: {
 ...
 */
const calculateAverageCustomerRating = (employeeId) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
 ...
 */
const calculateTotalReviews = (employeeId) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const calculateTotalRewardApprovalsRejections = (employeeId) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const calculateTotalRewardApprovalsApproved = (employeeId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield rewardRedemption_1.RewardRedemptionModel.countDocuments({
        employee_id: employeeId,
        status: 'approved'
    });
 ...
 */
const calculateTotalRewardApprovalsRejected = (employeeId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield rewardRedemption_1.RewardRedemptionModel.countDocuments({
        employee_id: employeeId,
 ...
 */
const calculateAverageRewardApprovalTime = (employeeId) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
 ...
 */
const calculateAllEmployeeStats = (employee_id) => __awaiter(void 0, void 0, void 0, function* () {
    const employeeId = new mongoose_1.Types.ObjectId(employee_id);
    const [totalVisitsHandled, totalCustomersServed, totalRevenueGenerated, averageCustomerRating, totalReviews, totalRewardApprovalsRejections, totalRewardApprovalsApproved, totalRewardApprovalsRejected, averageRewardApprovalTime] = yield Promise.all([
