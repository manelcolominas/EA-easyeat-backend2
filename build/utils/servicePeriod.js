...
function getFullMenu(restaurant_id_1) {
    return __awaiter(this, arguments, void 0, function* (restaurant_id, now = new Date()) {
        ...
        return dishes.map((dish) => {
            var _a, _b;
            return (Object.assign(Object.assign({}, dish.toObject()), { isAvailableNow: (_b = (_a = dish.availableAt) === null || _a === void 0 ? void 0 : _a.some((p) => activePeriods.includes(p))) !== null && _b !== void 0 ? _b : false }));
        });
    });
}
