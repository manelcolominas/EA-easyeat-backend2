...
const calculateTotalSpentInTheRestaurantLasts90Days = (customer_id, restaurant_id) =>
...
const calculateTotalSpentInOthersRestaurantsLasts90Days = (customer_id, restaurant_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const ninetyDaysAgo = new Date();
    ninetyDaysAgo.setDate(ninetyDaysAgo.getDate() - 90);
    const result = yield visit_1.VisitModel.aggregate([
...
const calculateAverageSpentInARestaurantLast90DaysByTheCustomers = (restaurant_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const ninetyDaysAgo = new Date();
    ninetyDaysAgo.setDate(ninetyDaysAgo.getDate() - 90);
    const result = yield visit_1.VisitModel.aggregate([
...
const calculateAverageSpentInARestaurantLast90DaysByVisits = (restaurant_id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const ninetyDaysAgo = new Date();
    ninetyDaysAgo.setDate(ninetyDaysAgo.getDate() - 90);
    const result = yield visit_1.VisitModel.aggregate([
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (pointsSystem.method === 'simple') {
      ...
      pointsToAssign = calculatePointsExponential(
        ...
        billAmount !== null && billAmount !== void 0 ? billAmount : 0,
