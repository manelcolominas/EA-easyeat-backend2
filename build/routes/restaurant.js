 ...
 *                 $ref: '#/components/schemas/Restaurant'
 */
router.get('/near-by', restaurant_1.default.getRestaurantsNearby);
/**
 * @openapi
 * /restaurants:
 *   get:
 ...
 */
router.get('/', restaurant_1.default.readAll);
/**
 * @openapi
 * /restaurants/deleted:
 *   get:
 ...
 *               $ref: '#/components/schemas/PaginatedRestaurants'
 */
router.get('/deleted', auth_1.authenticate, (0, auth_1.requireRole)('admin'), restaurant_1.default.readAllDeleted);
/**
 * @openapi
 * /restaurants/filter:
 *   get:
 ...
 */
router.get('/:restaurantId', restaurant_1.default.readRestaurant);
/**
 * @openapi
 ...
 */
router.get('/:restaurantId/deleted', auth_1.authenticate, (0, auth_1.requireRole)('admin'), restaurant_1.default.readDeletedRestaurant);
/**
 * @openapi
 ...
 *         description: Deleted restaurant not found
 */
router.get('/:restaurantId/full/deleted', auth_1.authenticate, (0, auth_1.requireRole)('admin'), restaurant_1.default.getDeletedRestaurantFull);
/**
 * @openapi
 * /restaurants/{restaurantId}:
 *   put:
 ...
 *         description: Restaurant not found
 */
router.get('/:restaurantId/badges', restaurant_1.default.getBadges);
/**
 * @openapi
 ...
 *         description: Deleted restaurant not found
 */
router.get('/:restaurantId/badges/deleted', auth_1.authenticate, (0, auth_1.requireRole)('admin'), restaurant_1.default.getDeletedRestaurantBadges);
/**
 * @openapi
 ...
 *         description: Restaurant not found
 */
router.get('/:restaurantId/statistics', auth_1.authenticate, (0, auth_1.requireRole)('admin', 'owner'), (0, auth_1.requireRestaurantAccess)('restaurantId'), restaurant_1.default.getStatistics);
/**
 * @openapi
 ...
 *         description: Deleted restaurant not found
 */
router.get('/:restaurantId/statistics/deleted', auth_1.authenticate, (0, auth_1.requireRole)('admin'), restaurant_1.default.getDeletedRestaurantStatistics);
/**
 * @openapi
 ...
 *         description: Restaurant not found
 */
router.get('/:restaurantId/employees', auth_1.authenticate, (0, auth_1.requireRole)('admin', 'owner'), (0, auth_1.requireRestaurantAccess)('restaurantId'), restaurant_1.default.getEmployees);
/**
 * @openapi
 ...
 *         description: Deleted restaurant not found
 */
router.get('/:restaurantId/employees/deleted', auth_1.authenticate, (0, auth_1.requireRole)('admin'), restaurant_1.default.getDeletedRestaurantEmployees);
/**
 * @openapi
 ...
 *         description: Restaurant not found
 */
router.get('/:restaurantId/dishes', restaurant_1.default.getDishes);
/**
 * @openapi
 ...
 *         description: Deleted restaurant not found
 */
router.get('/:restaurantId/dishes/deleted', auth_1.authenticate, (0, auth_1.requireRole)('admin'), restaurant_1.default.getDeletedRestaurantDishes);
/**
 * @openapi
 ...
 *         description: Restaurant not found
 */
router.get('/:restaurantId/rewards', restaurant_1.default.getRewards);
/**
 * @openapi
 ...
 *         description: Deleted restaurant not found
 */
router.get('/:restaurantId/rewards/deleted', auth_1.authenticate, (0, auth_1.requireRole)('admin'), restaurant_1.default.getDeletedRestaurantRewards);
/**
 * @openapi
 ...
 *         description: Restaurant not found
 */
router.get('/:restaurantId/visits', restaurant_1.default.getVisits);
/**
 * @openapi
 ...
 *         description: Deleted restaurant not found
 */
router.get('/:restaurantId/visits/deleted', auth_1.authenticate, (0, auth_1.requireRole)('admin'), restaurant_1.default.getDeletedRestaurantVisits);
/**
 * @openapi
 ...
 *         description: Restaurant not found
 */
router.get('/:restaurantId/reviews', restaurant_1.default.getReviews);
/**
 * @openapi
 ...
 *         description: Deleted restaurant not found
 */
router.get('/:restaurantId/reviews/deleted', auth_1.authenticate, (0, auth_1.requireRole)('admin'), restaurant_1.default.getDeletedRestaurantReviews);
/**
 * @openapi
 ...
 *         description: Restaurant not found
 */
router.get('/:restaurantId/customers', restaurant_1.default.getRestaurantCustomers);
/**
 * @openapi
 ...
 *         description: Restaurant not found
 */
router.get('/:restaurantId/customers/deleted', auth_1.authenticate, (0, auth_1.requireRole)('admin'), restaurant_1.default.getDeletedRestaurantCustomers);
/**
 * @openapi
 ...
 */
router.get('/:restaurantId/top-dish', restaurant_1.default.getTopDish);
