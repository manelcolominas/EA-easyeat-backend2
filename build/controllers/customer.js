...
// ─── Read (single) ────────────────────────────────────────────────────────────
const readCustomer = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const readDeletedCustomer = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
...
const readCustomerFull = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
...
const readDeletedCustomerFull = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
...
const getCustomerAllBadges = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
...
const getCustomerAllFavouriteRestaurants = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
      const { page, limit, skip } = (0, pagination_1.getPaginationOptions)(req.query);
...
const getCustomerAllReviews = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
      const { page, limit, skip } = (0, pagination_1.getPaginationOptions)(req.query);
...
const getCustomerAllVisits = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
      const { page, limit, skip } = (0, pagination_1.getPaginationOptions)(req.query);
...
const getCustomerAllDeletedVisits = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
      const { page, limit, skip } = (0, pagination_1.getPaginationOptions)(req.query);
...
const getCustomerAllPointsWallet = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
      const { page, limit, skip } = (0, pagination_1.getPaginationOptions)(req.query);
...
const getCustomersByRestaurant = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
const softDeleteCustomer = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
 ...
 */
const restoreCustomer = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
 ...
 */
const hardDeleteCustomer = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { customer_id } = req.params;
    try {
