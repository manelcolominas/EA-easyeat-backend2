...
const readEmployee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const readDeletedEmployee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const readAllDeleted = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { page, limit, skip } = (0, pagination_1.getPaginationOptions)(req.query);
...
const readByRestaurant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const readDeletedByRestaurant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { restaurant_id } = req.params;
        const { page, limit, skip } = (0, pagination_1.getPaginationOptions)(req.query);
...
const getEmployeesByRestaurantStats = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { restaurant_id } = req.params;
...
const softDeleteEmployee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const restoreEmployee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const hardDeleteEmployee = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
