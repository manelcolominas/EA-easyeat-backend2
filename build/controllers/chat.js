...
exports.deleteMessage =
  ...
  exports.getRestaurantConversations =
  exports.getCustomerConversations =
  exports.createOrGetConversation =
    void 0;
...
const createOrGetConversation = (req, res) =>
...
const getCustomerConversations = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getRestaurantConversations = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const markConversationAsRead = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { conversationId } = req.params;
      const { userId } = req.body;
