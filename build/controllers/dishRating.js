 ...
 */
const rateOrUpdateDish = (req, res, next) =>
 ...
 */
const softDeleteRating = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const { id } = req.params;
...
const getRatingSummary = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { dish_id } = req.params;
    try {
...
const getTopDishByRestaurant = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getTopDishesByRestaurant = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { restaurant_id } = req.params;
    try {
