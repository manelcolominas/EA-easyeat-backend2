...
const readDeletedBadge = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const badge_id = req.params.badge_id;
    try {
...
const readDeletedByCustomer = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { customer_id } = req.params;
      const { page, limit, skip } = (0, pagination_1.getPaginationOptions)(req.query);
...
const updateBadge = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const badge_id = req.params.badge_id;
    try {
...
const softDeleteBadge = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const badge_id = req.params.badge_id;
    try {
...
const restoreBadge = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const badge_id = req.params.badge_id;
    try {
...
const hardDeleteBadge = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const badge_id = req.params.badge_id;
    try {
