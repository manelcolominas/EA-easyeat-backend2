...
const getEmployeeStatistics = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const calculateAndSaveEmployeeStatistics = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { employee_id } = req.params;
    try {
...
const recalculateEmployeeStatistics = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { employee_id } = req.params;
    try {
        const stats = yield employeeStats_1.default.calculateAndSaveEmployeeStatistics(employee_id);
        return res.status(200).json({
