...
const createStatistics = (req, res, next) =>
...
const readStatistics = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteStatistics = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { statistics_id } = req.params;
    try {
...
const visitsPerHour = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const averagePoints = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const restaurantObjectId = getRestaurantObjectId(req);
    if (!restaurantObjectId) {
...
const loyalCustomers = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const restaurantObjectId = getRestaurantObjectId(req);
