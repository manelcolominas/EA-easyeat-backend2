...
const readDeletedVisit = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const visit_id = req.params.visit_id;
    try {
...
const softDeleteVisit = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const visit_id = req.params.visit_id;
    try {
...
const restoreVisit = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const visit_id = req.params.visit_id;
    try {
...
const hardDeleteVisit = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const visit_id = req.params.visit_id;
    try {
