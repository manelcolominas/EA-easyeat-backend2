...
exports.isCustomer = exports.isStaff = exports.isOwner = exports.isAdmin = exports.requireEmployeeOwnerOrSelfOrAdmin = exports.requireRestaurantAccess = exports.requireCustomerAccess = exports.requireSelfOrAdmin = exports.requireRole = exports.authenticate = void 0;
...
const requireEmployeeOwnerOrSelfOrAdmin = (paramName = 'employee_id') => {
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Self check
        if (String(req.user.id) === String(employeeId))
            return next();
        ...
        try {
            ...
            if (currentRole === 'owner') {
                ...
                if (String(req.user.restaurant_id) === String(employee.restaurant_id))
                    return next();
