...
// ─── Reusable primitives ──────────────────────────────────────────────────────
const timetableDaySchema = joi_1.default.array().items(
...
exports.Schemas = {
  ...
  dish: {
    create: joi_1.default.object({
      ...
      allergens: joi_1.default
        .array()
        .items(joi_1.default.string().valid('gluten', 'shellfish', 'nuts', 'dairy', 'eggs', 'soy', 'fish', 'sesame', 'mustard', 'celery', 'lupins', 'molluscs', 'sulphites')),
      ...
      flavorProfile: joi_1.default
        .array()
        .items(joi_1.default.string().valid('spicy', 'mild', 'sweet', 'sour', 'salty', 'bitter', 'umami', 'smoky', 'rich', 'light', 'creamy', 'tangy', 'fresh', 'hearty', 'nutty')),
